  ...
  if(isset($_POST['delete_booking']))
    {
            ...
            $rc=$stmt->bind_param('ssssi',  $u_loan_type, $u_car_regno, $u_car_bookdate, $u_car_book_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST"> 
            ...
            <button type="submit" name="delete_booking" class="btn btn-danger">Delete Appointment</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
