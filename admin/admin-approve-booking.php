    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Approve Appointment</li>
        </ol>
        <hr>
        <div class="card">
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="email" readonly value="<?php echo $row->u_loan_type;?>" class="form-control" name="u_car_type">
            </div>
            ...
            <button type="submit" name="approve_booking" class="btn btn-success">Save</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
