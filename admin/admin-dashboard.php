            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $user;?></span>Creditors</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $driver;?></span>Agents</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $vehicle;?></span>Loan Offers</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $book;?></span>Appointments</div>
              </div>
