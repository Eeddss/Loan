    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-header">
          Give us your Feedback or other inquiry
        </div>
        <div class="card-body">
          <!--Add User Form-->
          <form method ="POST"> 
            ...
            <?php }?>
            <div class="form-group">
                <label for="exampleInputEmail1">Feedback / Inquiry</label>
                <textarea type="text" class="form-control" placeholder = "Give Your Feedback" id="exampleInputEmail1" name="f_content"></textarea>
            </div>
            <button type="submit" name="give_feedback" class="btn btn-success">Send</button>
          </form>
          <!-- End Form-->
        </div>
      </div>
